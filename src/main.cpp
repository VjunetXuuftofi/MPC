    ...
    if (sdata.size() > 2 && sdata[0] == '4' && sdata[1] == '2') {
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          Eigen::VectorXd ptsx_eigen(ptsx_vec.size());
          Eigen::VectorXd ptsy_eigen(ptsy_vec.size());
          double px = j[1]["x"];
          double py = j[1]["y"];
          double psi = j[1]["psi"];
          double v = j[1]["speed"];
          ...
          for (int i = 0; i < ptsx_vec.size(); i++) {
            ...
            double y = x_diff*-sin_psi + y_diff*cos_psi;
            ptsx_eigen(i) = x;
            ptsy_eigen(i) = y;
            ptsx_vec[i] = x;
            ptsy_vec[i] = y;
          ...
          */
          ...
          msgJson["next_x"] = ptsx_vec;
          msgJson["next_y"] = ptsy_vec;
